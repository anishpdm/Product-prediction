      ...
      <nav class="navbar navbar-expand-lg navbar-light sticky-top" data-navbar-on-scroll="data-navbar-on-scroll">
        <div class="container"><a class="navbar-brand" href="index.html">
          ...
          <div class="collapse navbar-collapse border-top border-lg-0 mt-4 mt-lg-0" id="navbarSupportedContent">
            ...
            <div class="d-flex ms-lg-4"><a class="btn btn-secondary-outline" href="signin.html">Sign In</a>
                <a class="btn btn-warning ms-3" href="signup.php">Sign Up</a>
              </div>
        ...
        <div class="container">
          <div class="row align-items-center">
            <div class="col-md-6 text-md-start text-center py-6">
                ...
                <a class="btn btn-warning ms-3" href="signin.html">Go To Register</a>
        ...
        <div class="container">
          ...
          <div class="row">
            ...
            <div class="col-lg-3 col-sm-6 mb-2"> <img class="mb-3 ms-n3" src="assets/img/category/icon3.png" width="75" alt="Feature" />
              ...
              <p class="mb-0 fw-medium text-secondary">Implement robust security measures to protect sensitive inventory data stored in the cloud.
<p>
            </div>
        ...
        <div class="container">
          <div class="row">
            <div class="col-lg-6">
              ...
              <p class="mb-4 fw-medium text-secondary"> Avoiding stockouts reduces missed sales opportunities, while minimizing overstock situations prevents excess inventory cost,</p>
        ...
        <div class="container">
          <div class="row">
            <div class="col-lg-6">
              ...
              <p class="mb-4 fw-medium text-secondary">While  a specific tool or software for creating assembly diagrams or processes.</p>
