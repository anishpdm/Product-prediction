      ...
      <nav class="navbar navbar-expand-lg navbar-light sticky-top" data-navbar-on-scroll="data-navbar-on-scroll">
        <div class="container"><a class="navbar-brand" href="index.html">
          ...
          <div class="collapse navbar-collapse border-top border-lg-0 mt-4 mt-lg-0" id="navbarSupportedContent">
            ...
            <div class="d-flex ms-lg-4"><a class="btn btn-secondary-outline" href="index.html">Sign In</a>
                <a class="btn btn-warning ms-3" href="index.php">Sign Up</a>
              </div>
        ...
        <div class="container">
          ...
          <div class="row">
            ...
            <div class="col-lg-3 col-sm-6 mb-2"> <img class="mb-3 ms-n3" src="assets/img/category/icon4.png" width="75" alt="Feature" />
              ...
              <p class="mb-0 fw-medium text-secondary"> Continuous Improvement ensure that the inventory management system remains effective and delivers ongoing value.</p>
            </div>
          </div>
          ...
          <div class="row">
            <div class="col-lg-6">
              ...
              <p class="mb-4 fw-medium text-secondary">
                Analyzing historical sales data, seasonality, <br/> market trends the system will predict future inventory requirements.</p>
